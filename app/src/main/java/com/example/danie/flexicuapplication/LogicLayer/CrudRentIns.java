...
public class CrudRentIns {
    ...
    public CrudRentIns(String name, String pay, String job, String rentStart, String rentEnd, String owner, String location, String rank, String pic, String status, String description) {
        this.name = name;
        this.pay = pay;
        this.job = job;
